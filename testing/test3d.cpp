err |= test2<Cuda::HostMemoryHeap<float, 3>, Cuda::HostMemoryHeap<double, 3> >(size3a, size3b, pos3a, pos3b, size3, smax3);
err |= test2<Cuda::HostMemoryHeap<double, 3>, Cuda::HostMemoryHeap<float, 3> >(size3a, size3b, pos3a, pos3b, size3, smax3);
